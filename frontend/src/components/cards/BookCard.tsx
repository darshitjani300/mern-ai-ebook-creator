...
const BookCard: React.FC<IBookProp> = (props) => {
  ...
  return (
    <div
      className="group relative bg-white rounded-xl overflow-hidden border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-xl hover:shadow-gray-100/50 hover:-translate-y-1 cursor-pointer"
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-0.75 bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </div>
  );
};
