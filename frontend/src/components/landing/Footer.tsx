        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            <a href="/" className="flex items-center space-x-2.5 group">
              <div className="w-10 h-10 bg-linear-to-br from-violet-500 to-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/30 group-hover:shadow-violet-500/50 transition-all duration-300 group-hover:scale-105">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                href="https://twitter.com/darshit_life1"
