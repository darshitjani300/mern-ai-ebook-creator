          ...
          <div className="hidden lg:flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <a
                  href="/signup"
                  className="px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-violet-400 to-purple-500 rounded-lg hover:from-violet-700 hover:to-violet-700 shadow-violet-500/30 hover:shadow-violet-500/50 transition-all duration-300 hover:scale-105"
                >
                  Get Started
                </a>
              </>
          ...
          <div className="px-4 py-4 border-t border-gray-100">
            {isAuthenticated ? (
              <div className="space-y-3">
                ...
                <button
                  className="w-full px-4 py-2.5 text-sm font-medium text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
                  onClick={() => logout()}
                >
              ...
              <div className="space-y-2">
                <a
                  href="/login"
                  className="block text-center px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200"
                >
                  Login
                </a>
                <a
                  href="/signup"
                  className="block text-center px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-violet-600 to-purple-600 rounded-lg shadow-lg shadow-violet-500/30 transition-all duration-200"
                >
                  Get Started
                </a>
              </div>
